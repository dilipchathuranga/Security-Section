        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <button class="btn btn-primary addNew"><i class="fa fa-plus"></i> Add New Designation</button>
...
$(document).ready(function(){
        ...
        $(".addNew").click(function(){
            empty_form();
            $("#modal").modal('show');
            $(".modal-title").html('Save Designation');
            $("#submit").html('Save Designation');
        ...
        $(".edit").click(function(){
            ...
            $("#submit").html('Update Designation');
